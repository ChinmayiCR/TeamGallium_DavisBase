...
public class Condition {
    ...
    public static Condition CreateCondition(String conditionString) {
        ...
        if(operator == null) {
            Handler.UnrecognisedCommand(conditionString, "Unrecognised operator. \nValid operators include =, >, <, >=, <=. \nPlease follow <column> <operator> <value>");
            return null;
        }
    ...
    private static Condition getConditionInternal(String conditionString, Operator operator, String operatorString) {
        ...
        if(parts.length != 2) {
            Handler.UnrecognisedCommand(conditionString, "Unrecognised condition. Please follow <column> <operator> <value>");
            return null;
        }
