...
public class DescTableQuery implements QueryInterface {
    ...
    public Result ExecuteQuery() {
        ...
        QueryInterface query = new SelectCmd(DatabaseConstants.DEFAULT_CATALOG_DATABASENAME, DatabaseConstants.SYSTEM_COLUMNS_TABLENAME, columns, conditionList, false);
