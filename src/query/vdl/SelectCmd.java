...
public class SelectCmd implements QueryInterface {
    ...
    public SelectCmd(String databaseName, String tableName, ArrayList<String> columns, ArrayList<Condition> conditions, boolean isSelectAll) {
