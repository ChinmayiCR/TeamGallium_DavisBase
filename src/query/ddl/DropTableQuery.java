...
public class DropTableQuery implements QueryInterface {
    ...
    public Result ExecuteQuery() {
        ...
        QueryInterface deleteQuery = new DeleteQuery(DatabaseConstants.DEFAULT_CATALOG_DATABASENAME, DatabaseConstants.SYSTEM_TABLES_TABLENAME, conditionList, true);
        ...
        if(!Utils.RecursiveDeletion(table)){
